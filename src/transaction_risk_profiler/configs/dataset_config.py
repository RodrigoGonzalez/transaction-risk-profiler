...
class DatasetCardConfig(BaseModel):
    ...
    The DatasetCardConfig class is a Pydantic model that represents the
    configuration of a dataset card. It contains the target variable, features,
    and other optional parameters that can be used to customize the dataset
    card.
